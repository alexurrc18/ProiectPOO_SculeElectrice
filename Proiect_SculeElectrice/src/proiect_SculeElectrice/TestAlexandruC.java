...
public class TestAlexandruC {
    public static void main(String[] args) {
        ...
        SculeElectrice scula1 = new SculeElectrice("Bosch", "USB-A",
                65.5, 423.33, 250);
        SculeElectrice scula2 = new SculeElectrice("Makita", "USB-C",
                73.4, 500, 475);
        SculeElectrice scula3 = new SculeElectrice("AEG", "Jack",
                83, 216.4, 308);
        ...
        SculeElectrice fierastrau1 = new FierastrauPendular(scula1, 26, 3200,
                "tija U", 87, true);
        SculeElectrice fierastrau2 = new FierastrauPendular(scula2, 20, 3000,
                "tija U", 95, true);
        SculeElectrice fierastrau3 = new FierastrauPendular(scula3,23, 3100,
                "SDS-Plus", 84, true);
        ...
        listaFierastraie.add(new FierastrauPendular("Bosch", "USB-C", 85.0, 450.0, 630.0, 31, 3350, "SDS-Plus", 90, true));
        ...
        listaSurubelnite.add(new SurubelnitaElectrica("Stanley", "USB-A", 90.0, 410.0, 600.0, "Pătrat", 1800, 2600, 70.0, true));
        listaSurubelnite.add(new SurubelnitaElectrica("Ryobi", "USB-C", 74.0, 380.0, 490.0, "Hexagonal", 1400, 2000, 63.0, false));
        ...
        listaSurubelnite.add(new SurubelnitaElectrica("Black+Decker", "Jack", 72.0, 370.0, 480.0, "Pătrat", 3000, 1900, 59.0, false));
        ...
        for(SurubelnitaElectrica surubelnita : listaSurubelnite) {
            ...
            for(FierastrauPendular fierastrau : listaFierastraie) {
                if(fierastrau.tipPrindere.equals("tija U") && fierastrau.nivelZgomot<80) System.out.println(fierastrau);
            }

        System.out.println("\n\n\n[FILTRARE] Surubelnite electrice:");
        for(SurubelnitaElectrica surubelnita : listaSurubelnite) {
            if(surubelnita.tipMandrina.equals("Hexagonal") && surubelnita.capacitateBaterie>2000) System.out.println(surubelnita + "\n");
        }
